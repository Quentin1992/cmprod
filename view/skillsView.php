<?php
$title = "Nos compétences - Chaud Mirette Productions";
$page = "skills";
 ?>
...
<header>
        ...
        <div>
            ...
            ou même le motion design et le pilotage de drone, notre équipe se charge de vous livrer un produit qui correspond à vos désirs et à votre image de marque.</p>
            <nav>
                <a href="#design" aria-label="Conception et rédaction">
                    <div>
            ...
            <a href="#design" aria-label="Nos compétences"><i class="fas fa-chevron-down"></i></a>
        </div>
    </header>
    <section>
        <div id="design">
            ...
            <div>
                ...
                Tout est possible et réalisable pour fournir un scénario de qualité, qui sera les fondations d'une réalisation réussie !</p>
                <a href="#" aria-label="Nos compétences"><i class="fas fa-chevron-up"></i></a>
            </div>
        </div>
        <div id="preprod">
            ...
            <div>
                ...
                Vous n'avez rien à vous soucier, notre équipe se charge de trouver les lieux, les accessoires, les figurants ou tout autre chose...</p>
                <a href="#" aria-label="Nos compétences"><i class="fas fa-chevron-up"></i></a>
            </div>
        </div>
        <div id="shooting">
            ...
            <div>
                ...
                Mouvements dans l'image, slowmotion, hyperlapse, travelling compensé, timelapse, accéléré, transtrav... Notre métier c'est l'image, et cela se ressent !</p>
                <a href="#" aria-label="Nos compétences"><i class="fas fa-chevron-up"></i></a>
            </div>
        </div>
        <div id="montage">
            ...
            <div>
                ...
                Le montage n'est pas seulement un assemblage d'images, c'est un travail très minutieux pour déﬁnir une ambiance particulière, selon ce que l'on VEUT faire ressortir de la réalisation.</p>
                <a href="#" aria-label="Nos compétences"><i class="fas fa-chevron-up"></i></a>
            </div>
        </div>
        <div id="motion">
            ...
            <div>
                ...
                Les infographies peuvent elles aussi apparaître dans le but d'animer un logo ou un texte, et ainsi d'y rajouter quelque chose d'original et de plus rarement vu.</p>
                <a href="#" aria-label="Nos compétences"><i class="fas fa-chevron-up"></i></a>
            </div>
        </div>
        <div id="drone">
            ...
            <div>
                ...
                Ce dernier possède la capacité de favoriser l'immersion et la fascination du spectateur.<br />
                Ayant obtenu le certificat de télé-pilote d'aéronefs, Chaud Mirette Productions est en mesure d'utiliser un drone afin de vous offrir des images aériennes d'une très grande qualité, à un coût modéré.</p>
                <a href="#" aria-label="Nos compétences"><i class="fas fa-chevron-up"></i></a>
            </div>
        </div>
    </section>
